...
namespace Objetos
{
    public class TipoAlergia
    {
        ...
        /// <summary>
        /// Método para inserir um novo tipo de alergia.
        /// </summary>
        /// <param name="tipoAlergia">Objeto TipoAlergia a ser inserido.</param>
        /// <returns>O ID do tipo de alergia inserido.</returns>
